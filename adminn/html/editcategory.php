...
// echo "<script> alert('$cname') </script>";
    $query = mysqli_query($conn, "update tblcategory set cname ='$cname' where categoryid=$eid");
    if ($query) {
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-xl">
                                        <div class="card mb-4">
                                            ...
                                            <?php
                                        $cid = $_GET['editid'];
                                        $ret = mysqli_query($conn, "select * from tblcategory where categoryid='$cid'");
                                        $cnt = 1;
                                            ...
                                            <div class="card-body">
                                                <form action="#" method="POST" id="addcategory_form">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="category" name="cname" value="<?php echo $fetch['cname']; ?>">
