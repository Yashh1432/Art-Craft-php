...
if (isset($_POST['Update'])) {
    ...
    $query = mysqli_query($conn, "update tblbrand set bname ='$bname' where brandid=$eid");
    if ($query) {
                                    ...
                                    <div class="card-body">
                                        <form action="#" method="POST" id="addbrand_form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php
                                                $bid = $_GET['editid'];
                                                $ret = mysqli_query($conn, "select * from tblbrand where brandid='$bid'");
                                                $cnt = 1;
                                                while ($fetch = mysqli_fetch_array($ret)) {

                                                ?>
                                                    <input type="text" class="form-control" id="brand" name="bname" value="<?php echo $fetch['bname']; ?>">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button name="back" class="btn btn-primary "><a href="category.php">Back</a></button>
