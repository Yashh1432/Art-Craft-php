...
if (isset($_GET['del'])) {
    ...
    $query = mysqli_query($conn, "delete from tblcategory where categoryid='$catid'");
    if ($query) {
...
if (isset($_GET['del'])) {
    ...
    $query = mysqli_query($conn, "delete from tblsubcategory where subcategoryid='$catid'");
...
if (isset($_GET['del'])) {
    $scatid = intval($_GET['del']);
    echo "<script>alert('$scatid')</script>";
    $query = mysqli_query($conn, "delete from tblbrand where brandid='$scatid'");
                                            ...
                                            <table class="table table-bordered mg-b-0">
                                                ...
                                                <thead class=" bg-dark text-light">
                                                    <tr>
                                                        ...
                                                        <th class="text-light">Cateory Name</th>
                                                        <th class="text-light">creation date</th>
                                                        <th class="text-light">Action</th>
                                                    </tr>
                                                </thead>

                                                <?php
                                                $query = $conn->query("SELECT * FROM `tblcategory` ");
                                                $cnt = 1;
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="editcategory.php?editid=<?php echo $fetch['categoryid']; ?>" class="table-link">
                                                                    <span class="fa-stack">
                                                    ...
                                                    if (isset($_POST['addcategory'])) {
                                                        ...
                                                        $cate = "INSERT INTO tblcategory (cname,added_date) VALUES ('$category',now())";
                                                        $insert_result = mysqli_query($conn, $cate);
                                                        if ($insert_result) {
                                                            echo "<script>alert('category added Successfully')</script>";
                                                            echo "<script>location.href='category.php'</script>";
                                                        } else {
                                                            echo "error:" . $conn->error;
                                                            echo "<script>alert('category not Adding Failed!  Try Again!')</script>";
                                                            echo "<script>location.href='category.php'</script>";
                                                        }
                                                    }
                                                    ?>
                                            ...
                                            <div class="table-responsive text-nowrap p-2">
                                                ...
                                                <table class="table table-bordered mg-b-0">
                                                    ...
                                                    <thead class=" bg-dark text-light">
                                                        <tr>
                                                            <th class="text-light">S.NO</th>
                                                            <th class="text-light">Sub Cateory Name</th>
                                                    ...
                                                    <?php
                                                    // $query = $conn->query("SELECT * FROM `tblsubcategory` ");
                                                    $query = $conn->query(" SELECT tblsubcategory.subcategoryid, tblsubcategory.sname,  tblsubcategory.added_date, tblcategory.cname
                                                    FROM tblcategory
                                                    INNER JOIN tblsubcategory ON tblcategory.categoryid = tblsubcategory.categoryid; ");
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="editsubcategory.php?editid=<?php echo $fetch['subcategoryid']; ?>" class="table-link">
                                                                        <span class="fa-stack">
                                                                            <i class="fa fa-square fa-stack-2x"></i>
                                                                            <i class="bi bi-pencil-square m-2"></i>
                                                                        </span>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-xl">
                                            <div class="card mb-4">
                                                ...
                                                <div class="card-body">
                                                    <form method="POST" id="addbrand_form">
                                                        <div class="form-group">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="table-responsive text-nowrap p-2">
                                                <table class="table table-bordered mg-b-0">
                                                    ...
                                                    <?php
                                                    $query = $conn->query("SELECT * FROM `tblbrand` ");
                                                    $cnt = 1;
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><?php echo $cnt; ?></td>
                                                                <td><?php echo $fetch['bname']; ?></td>
                                                                <td><?php echo $fetch['added_date']; ?></td>

                                                                <td>
                                                                    <a href="editbrand.php?editid=<?php echo $fetch['brandid']; ?>" class="table-link">
                                                                        <span class="fa-stack">
                                                                            <i class="fa fa-square fa-stack-2x"></i>
                                                                            <i class="bi bi-pencil-square m-2"></i>
                                                                        </span>
                                                                    </a>
                                                                    <a href="category.php?del=<?php echo $fetch['brandid']; ?>" class="table-link danger">
                                                                        <span class="fa-stack">
                                                                            <i class="bi bi-trash3-fill text-danger"></i>
                                                        ...
                                                        if (isset($_POST['addbrand'])) {
                                                            ...
                                                            $insert = "INSERT INTO tblbrand (bname,added_date) VALUES ('$brand',now())";
                                                            ...
                                                            if ($insert_result) {
                                                                ...
                                                                echo "error:" . $conn->error;
                                                                echo "<script>alert('Brand not Adding Failed!  Try Again!')</script>";
                                                                echo "<script>location.href='category.php'</script>";
                                                            }
                                                        }
                                                        ?>
...
if (isset($_POST['addsubcategory'])) {
    ...
    // echo $subcate;
    $insert_result = mysqli_query($conn, $subcate);
    if ($insert_result) {
        echo "<script>alert('sub category added Successfully')</script>";
        echo "<script>location.href='category.php'</script>";
    } else {
        echo "error:" . $conn->error;
        echo "<script>alert('sub category not Adding Failed!  Try Again!')</script>";
        echo "<script>location.href='category.php'</script>";
    }
}
